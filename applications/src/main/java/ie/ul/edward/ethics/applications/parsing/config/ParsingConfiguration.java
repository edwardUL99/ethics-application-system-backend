package ie.ul.edward.ethics.applications.parsing.config;

import ie.ul.edward.ethics.applications.parsing.ApplicationParser;
import ie.ul.edward.ethics.applications.parsing.ParsedApplication;
...
public class ParsingConfiguration {
     ...
     */
    @Bean
    public ParsedApplication[] parsedApplications() {
        Resource resource = getApplicationResource();
        try {
            ParsedApplication[] applications = applicationParser.parse(resource.getInputStream());
