...
public class Account {
    ...
    /*
    TODO add class that saves the confirmation token to the database.
    Add method to account service to confirm the account which takes parameter account and confirmation token
    If they match, the account.confirmed is set to true and confirmation token deleted from the database
    Else, false is returned.
    Add the controller endpoints outlined in the onenote notebook page

    Add neccessary tests too
     */
